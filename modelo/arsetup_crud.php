...
if ($lcaccion == "SAVE"){
	...
	$lctypdesc = mysqli_real_escape_string($oConn,$_POST["ctypdesc"]);
	...
	$lcsql = " insert into arsetup(ninvno,ncashno,nadjno,nncno,nndno,ncotno,ninvlinmax,
									ccustno,cpaycode,cwhseno,ccateno,carsetup,ctypcost,ctypdesc,ctaxproc,
									linvno,lestados,lcoti,minvno,mestados,mcoti,ncashamt)
							values($lninvno,$lncashno,$lnadjno,$lnncno,$lnndno,$lncotno,$lninvlinmax,
									'$lccustno','$lcpaycode','$lcwhseno','$lccateno','C','$lctypcost','$lctypdesc','$lctaxproc',
	...
	$lcsql = " update arsetup set ninvno = $lninvno,ncashno=$lncashno, nadjno=$lnadjno,
									nncno=$lnncno, nndno=$lnndno, ncotno=$lncotno, ctypdesc = '$lctypdesc',
